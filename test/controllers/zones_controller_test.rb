...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference("Zone.count") do
      post zones_url, params: { zone: { description: @zone.description, manager_id: @zone.manager_id, name: @zone.name, open: @zone.open, ssid: @zone.ssid } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { description: @zone.description, manager_id: @zone.manager_id, name: @zone.name, open: @zone.open, ssid: @zone.ssid } }
